...
def barback_tips(bar_back, total_tips, bar_back_tip_percent,
                 total_hours, emp_1_hours, emp_2_hours, emp_3_hours, emp_4_hours):

    barback = 0
    if bar_back.startswith("y") or bar_back.startswith("Y"):
        barback = barback + round(total_tips * bar_back_tip_percent/100, 2)
    ...
    if emp_3_hours == 0:
        ...
        return [barback_total_tipout, bartender1_tipout_barback, bartender2_tipout_barback,
                bartender3_tipout_barback, bartender4_tipout_barback]
...
def hourly_rate(total_money, total_hours, emp_1_hours, emp_2_hours, emp_3_hours, emp_4_hours):
    hourly = total_money / total_hours
    if emp_3_hours == 0:
        emp_1_hourly = hourly * emp_1_hours
        emp_2_hourly = hourly * emp_2_hours
        return [hourly, emp_1_hourly, emp_2_hourly]

    elif emp_4_hours == 0:
        emp_1_hourly = hourly * emp_1_hours
        emp_2_hourly = hourly * emp_2_hours
        emp_3_hourly = hourly * emp_3_hours
        return [hourly, emp_1_hourly, emp_2_hourly, emp_3_hourly]
